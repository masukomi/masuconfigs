# Prints out the description of a fish function.
#
...
#
# created by  Jonathan Price
# originally found here: https://github.com/jonmarkprice/fish-functions/blob/master/desc.fish
